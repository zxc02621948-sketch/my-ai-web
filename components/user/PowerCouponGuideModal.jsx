      ...
      >
        ...
        <div className="sticky top-0 bg-gradient-to-r from-purple-600 to-purple-700 px-3 py-2 flex justify-between items-center rounded-t-lg">
          <h2 className="text-lg font-bold text-white flex items-center gap-2">
            ...
            {hasNoCoupon ? '新作品加成券說明' : '如何使用新作品加成券'}
          </h2>
          <button
            onClick={onClose}
            ...
            <>
              ...
              <div className="bg-purple-900/20 border border-purple-600/30 rounded-lg p-2">
                ...
                <p className="text-gray-300 leading-relaxed">
                  新作品加成券可以讓你的<span className="text-yellow-400 font-semibold">舊作品重新獲得「新作品加成」效果</span>，
                  大幅提升曝光率和流量，讓更多人看到你的作品！
                </p>
                <p className="text-gray-400 text-sm mt-2">
                  💡 券本身有有效期（7天或30天），在有效期內可以隨時使用<br/>
                  ⚡ 使用後作品獲得新作品加成效果，持續 <span className="text-yellow-400 font-semibold">10小時</span>
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    { step: 1, text: '點擊你想加成的作品，打開詳細彈窗' },
                    { step: 2, text: '在彈窗中找到紫色的「🎫 加成券」按鈕' },
                    { step: 3, text: '選擇券種（7天券或30天券）' },
                    { step: 4, text: '確認後，該作品將重新獲得新作品的曝光加成！' }
                  ].map(({ step, text }) => (
            ...
            <>
              ...
              <div className="bg-green-900/20 border border-green-600/30 rounded-lg p-2 text-center">
                ...
                <h3 className="text-lg font-semibold text-green-300 mb-1">
                  你目前有 <span className="text-yellow-400 text-2xl">{couponCount}</span> 張可用的加成券
                </h3>
                <p className="text-gray-400 text-sm">趕快為你的作品加成吧！</p>
              </div>
                ...
                <div className="space-y-3">
                  {[
                    { 
                      step: 1, 
                      text: '前往你的作品列表',
                      detail: '在個人頁面的「上傳作品」分頁中找到想要加成的作品'
                    },
                    { 
                      step: 2, 
                      text: '點擊作品，打開詳細彈窗',
                      detail: '點擊任何一個你的作品，會彈出詳細資訊視窗'
                    },
                    { 
                      step: 3, 
                      text: '找到「使用加成券」按鈕',
                      detail: '在彈窗中找到紫色的「🎫 加成券」按鈕'
                    },
                    { 
                      step: 4, 
                      text: '選擇券種並確認',
                    ...
                    { 
                      step: 5, 
                      text: '完成！作品獲得加成',
                      detail: '該作品將重新獲得新作品的曝光加成，獲得更多流量'
                    }
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      券在有效期內可以隨時使用，使用後作品會獲得更高的曝光率和推薦權重，效果持續 <span className="text-yellow-400 font-semibold">10小時</span>。
                      建議選擇你最滿意的作品使用，效果更佳！
                    </p>
                  </div>
                </div>
