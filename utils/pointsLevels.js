...
export const LEVELS = [
  ...
  { 
    ...
    min: 150, 
    color: "bg-green-500",
    rewards: ["每日上傳 6 張圖片", "頭像框調色盤", "基本功能使用權"]
  },
  { 
    key: "lv3", 
    rank: "LV3", 
  ...
  { 
    ...
    min: 1000, 
    color: "bg-cyan-500",
    rewards: ["每日上傳 8 張圖片", "迷你播放器釘選功能", "頭像框調色盤", "基本功能使用權"]
  },
  { 
    key: "lv5", 
    rank: "LV5", 
    ...
    min: 2000, 
    color: "bg-indigo-500",
    rewards: ["每日上傳 9 張圖片", "迷你播放器釘選功能", "頭像框調色盤", "基本功能使用權"]
  },
  { 
    key: "lv6", 
    rank: "LV6", 
    ...
    min: 3500, 
    color: "bg-purple-500",
    rewards: ["每日上傳 10 張圖片", "迷你播放器釘選功能", "頭像框調色盤", "基本功能使用權"]
  },
  { 
    key: "lv7", 
    rank: "LV7", 
    ...
    min: 5000, 
    color: "bg-pink-500",
    rewards: ["每日上傳 11 張圖片", "迷你播放器釘選功能", "頭像框調色盤", "基本功能使用權"]
  },
  { 
    key: "lv8", 
    rank: "LV8", 
    ...
    min: 7000, 
    color: "bg-yellow-500",
    rewards: ["每日上傳 12 張圖片", "迷你播放器釘選功能", "頭像框調色盤", "基本功能使用權"]
  },
  { 
    key: "lv9", 
    rank: "LV9", 
    ...
    min: 9000, 
    color: "bg-orange-500",
    rewards: ["每日上傳 13 張圖片", "迷你播放器釘選功能", "頭像框調色盤", "基本功能使用權"]
  },
  { 
    key: "lv10", 
    rank: "LV10", 
    ...
    min: 10000, 
    color: "bg-red-600",
    rewards: ["每日上傳 14 張圖片", "迷你播放器釘選功能", "頭像框調色盤", "基本功能使用權"]
  },
];
